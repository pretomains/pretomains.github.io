...
import { Flame, ArrowRight, Download, Video, ExternalLink } from 'lucide-react';
          ...
          return (
            <div
              ...
              style={{
                ...
                border: isAd ? '1.5px solid #F59E0B' : '1.5px solid #FCA5A5',
                overflow: 'hidden',
                display: 'flex',
                flexDirection: 'column',
                boxShadow: isAd ? '0 8px 24px rgba(245, 158, 11, 0.12)' : '0 8px 24px rgba(220, 38, 38, 0.08)',
                position: 'relative'
              }}
            >
              <PdfIconCardHeader
              ...
              <div style={{ padding: '1rem 1.15rem 1.15rem 1.15rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: 'auto' }}>
                  {isAd ? (
                    <a 
                      href={item.download_link && item.download_link !== '#' ? item.download_link : undefined}
                      target={item.download_link && item.download_link !== '#' ? "_blank" : undefined}
